...
using Human_Resource_Information_System.ViewController.MD;
...
namespace Human_Resource_Information_System
{
    public partial class Main : Form
    {
        ...
        private void btn_color_reset()
        {
            ...
            btn_summary_report.BackColor = menuStrip1.BackColor;
        }
        ...
        private void open_generate13month()
        {
        ...
        private void open_viewgeneratedpayroll()
        {
            ...
            lbl_modname.Text = btn_summary_report.Text;
            btn_summary_report.BackColor = panel2.BackColor;
            colormain = panel2.BackColor;
            color2 = Color.Peru;
        ...
        {
            RPT_RES_entry2 form = new RPT_RES_entry2("P204");
            form.Show();
        ...
        {
            RPT_RES_entry2 form = new RPT_RES_entry2("M105");
            form.Show();
        ...
        {
            RPT_RES_entry2 form = new RPT_RES_entry2("P209");
            form.Show();
        ...
        private void btn_leaves_entry_Click(object sender, EventArgs e)
        {
            //open_leavesentry();
            rpt_payroll_summary rpt_payrollsummary = new rpt_payroll_summary();
            closechild();
        ...
        private void employeeShiftSchedToolStripMenuItem_Click(object sender, EventArgs e)
        {
            m_Emp_ShifSchedule ss = new m_Emp_ShifSchedule();
            ss.ShowDialog();
        }

        private void journalizePayrollTransactionsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            journalize frm = new journalize();
            frm.ShowDialog();
        }

        private void witholdingSummaryReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            RPT_RES_entry2 form = new RPT_RES_entry2("P201");
            form.Show();
        }

        private void thMonthPayReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            RPT_RES_entry2 form = new RPT_RES_entry2("P205");
            form.Show();
        }

        private void leaveStatusReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            RPT_RES_entry2 form = new RPT_RES_entry2("P207");
            form.Show();
        }
    }
}
