...
namespace Human_Resource_Information_System
{
    ...
    {
        public static string servers = System.IO.File.Exists(@"C:\RightApps\serverIP.txt") ? System.IO.File.ReadAllText(@"C:\RightApps\serverIP.txt").Trim() : "127.0.0.1";
        public static String db_str = System.IO.File.Exists(@"C:\RightApps\localDB.txt") ? System.IO.File.ReadAllText(@"C:\RightApps\localDB.txt").Trim() : "db";  

        public static String lcl_db = db_str.StartsWith("beta_", StringComparison.OrdinalIgnoreCase) ||
                                        db_str.StartsWith("live_", StringComparison.OrdinalIgnoreCase) ||
                                        db_str.StartsWith("past_", StringComparison.OrdinalIgnoreCase)
                                    ? db_str 
                                    : "live_" + db_str; // "live_" + db_str;  //"drschoice"; drschoice_capitol  "live_";  
        public static String lcl_past_db = db_str.StartsWith("beta_", StringComparison.OrdinalIgnoreCase) ||
                                        db_str.StartsWith("live_", StringComparison.OrdinalIgnoreCase) ||
                                        db_str.StartsWith("past_", StringComparison.OrdinalIgnoreCase)
                                    ? db_str
                                    : "past_" + db_str; //    "past_" + db_str;  //past_    drschoice_capitol

        public static String svr_pass = System.IO.File.Exists(@"C:\RightApps\x08p.txt") ? System.IO.File.ReadAllText(@"C:\RightApps\x08p.txt").Trim() : "Rightech777";  
        public static String svr_user = System.IO.File.Exists(@"C:\RightApps\x08.txt") ? System.IO.File.ReadAllText(@"C:\RightApps\x08.txt").Trim() : "postgres"; 
        public static String svr_port = System.IO.File.Exists(@"C:\RightApps\port.txt") ? System.IO.File.ReadAllText(@"C:\RightApps\port.txt").Trim() : "5432"; 
        public static String schema_static = "rssys";

        public String schema = schema_static;
        public String live_db = lcl_db;
        public String past_db = lcl_past_db;
        public static String selected_db = lcl_db;

        string cipher = "", mac_add = "", decipher = "";
        String ok = "";

        public static String hris_url = "http://" + servers + ":8080/hris-2023/timekeeping";
        public static String curr_branch = System.IO.File.Exists(@"C:\RightApps\localBranch.txt") ? System.IO.File.ReadAllText(@"C:\RightApps\localBranch.txt").Trim() : "000";

        /* public static String driveloc = System.IO.File.ReadAllText("C:\\RightApps\\serverIP.txt"); 
         public static String comp_folder = System.IO.File.ReadAllText(@"C:\RightApps\localDB.txt").ToUpper();  ///MukJa  //OCS   //44Joseph
         public static String db_str = System.IO.File.ReadAllText("C:\\RightApps\\localDB.txt");  
         public static String lcl_db = "live_" + db_str;   
         public static String lcl_past_db = "past_" + db_str; 
         public static String svr_pass = "Rightech777";
         public static String svr_user = "postgres";
         public static String svr_port = "5432";
         public static String schema_static = "rssys";

         string cipher = "", mac_add = "", decipher = "";
         String ok = "";
         //public static String servers = System.IO.File.ReadAllText(driveloc + comp_folder + "\\HRPublish\\serverIP.txt");
         //public static String biometricip = System.IO.File.ReadAllText(driveloc + comp_folder + "\\HRPublish\\ip.txt");
         //public static String biometricport = System.IO.File.ReadAllText(driveloc + comp_folder + "\\HRPublish\\port.txt");
         //public SDKHelper SDK = new SDKHelper();
         public static String servers = System.IO.File.ReadAllText("C:\\RightApps\\serverIP.txt");  
         public static String hris_url = "http://" + servers + ":8080/hris-2023/timekeeping";  //

         public String schema = schema_static;
         public static String curr_branch = System.IO.File.ReadAllText(@"C:\RightApps\localBranch.txt");
        ...
        */
        ...
        {
            get { return selected_db; }
            set { selected_db = value; }
        }

        public static String ch_curr_branch
        {
            get { return curr_branch; }
            set { curr_branch = value; }
        }

        public thisDatabase ()
        {
            gm = new GlobalMethod();
            conn = new NpgsqlConnection("Server=" + servers + ";Port=" + svr_port + ";User Id=postgres;Password=" + svr_pass + ";Database=" + selected_db + ";");
            //connectbiometric();
        }
        ...
        public void connectbiometric() {
           /*
            if (!SDK.GetConnectState())
            {
                ...
                int ret = SDK.sta_ConnectTCP(biometricip, biometricport, "0");
                if (ret == 1)
                {
                    //getDeviceInfo();
        ...
        public String validate_login_return_branch(String user, String pass, String comp)
        {
            try
            {
                String flag = null;
                ...
                String SQL = "Select branch FROM " + schema + ".X08 WHERE uid='" + user.ToUpper() + "' AND pwd='" + pass + "' AND active = true";
        ...
        {
            thisDatabase db = new thisDatabase();
            DataTable dt = db.QueryOnTableWithParams("x08", "opr_name", "uid='" + userid + "'", "");
            String fullName = "";
        ...
        public Boolean get_isMainBranch(String branch = "")
        {
            thisDatabase db = new thisDatabase();
            ...
            DataTable dt = db.QueryOnTableWithParams("m99", "main_branch", " branch='" + branch + "'", "");
            Boolean flag = false;
        ...
        public String get_period_dateto(String fy, String mo)
        {
            String val = "";
            ...
            try
            {
                dt = QueryBySQLCode("SELECT TO_CHAR(\"to\", 'yyyy-mm-dd') AS to FROM rssys.x03 WHERE fy='" + fy + "' AND mo='" + mo + "' ");
        ...
        public String get_period_datefrom(String fy, String mo)
        {
            String val = "";
            DataTable dt = null;
            ...
            try
            {
                dt = QueryBySQLCode("SELECT TO_CHAR(\"from\", 'yyyy-mm-dd') AS from FROM rssys.x03 WHERE fy='" + fy + "' AND mo='" + mo + "' ");
        ...
        public String get_m99comp_name(String branch = "")
        {
            ...
            DataTable dt = this.QueryOnTableWithParams("m99", "comp_name", " branch='" + branch + "'", "");
        ...
        public String get_m99comp_tel()
        {
            String val = "";

            DataTable dt = this.QueryOnTableWithParams("m99", "comp_tel", "", "");

            for (Int32 i = 0; i < dt.Rows.Count; i++)
            {
                //tdate = Convert.ToDateTime(dt.Rows[i]["trnx_date"]).ToString("MMM dd, yyyy");
                val = dt.Rows[i]["comp_tel"].ToString();
            }
        ...
        {
            String system_loc = thisDatabase.servers;
            String branch = "000";

            if (String.IsNullOrEmpty(GlobalClass.branch) == false)
            {
                branch = GlobalClass.branch;
            }

            DataTable dt = this.QueryOnTableWithParams("m99", "system_loc", " branch='" + branch + "'", "");

            try
            {
                system_loc = @"\\" + thisDatabase.servers + "\\" + dt.Rows[0]["system_loc"].ToString();
        ...
        public DataTable get_customer_list(String col= "*, d_name AS Customer", String WHERE = "")
        {
            return this.QueryOnTableWithParams("m06", col, WHERE, "ORDER BY d_name ASC");
        }
