...
namespace Human_Resource_Information_System
{
    public partial class m_HDMF : Form
    {
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            String code = "", bracket1 = "", bracket2 = "", pct = "", emp_ee = "", emp_er = "", at_code = "";
            ...
            pct = txt_pct.Text.ToString();
            emp_ee = txt_emp_ee.Text.ToString();
            emp_er = txt_emp_er.Text.ToString();
            at_code = cbo_cledger.SelectedValue.ToString();
            if (isnew)
            {
                col = "code,bracket1,bracket2,pct,emp_ee,emp_er,at_code";
                val = "" + db.str_E(code) + ",'" + bracket1 + "','" + bracket2 + "','" + emp_ee + "','" + pct + "','" + emp_er + "','" + at_code + "'";
            ...
            {
                col = "bracket1='" + bracket1 + "',bracket2='" + bracket2 + "',pct='" + pct + "',emp_er='" + emp_er + "',emp_ee='" + emp_ee + "',at_code='" + at_code + "'";
        ...
        private void m_HDMF_Load(object sender, EventArgs e)
        {
            ...
            disp_list();
            gc.load_account_title(cbo_cledger);
        }
            ...
            try
            {
                ...
                if (dgv_list.Rows.Count > 1 && !String.IsNullOrEmpty(id))
                {
                    try
                    {
                        ...
                        cbo_cledger.SelectedValue = db.get_colval("hr_hdmf", "at_code", "code= '" + id + "'");
                    }
                    catch (Exception er) { }
        ...
        private void disp_search_list(String col)
        {
            ...
            DataTable dt = db.QueryBySQLCode("SELECT * from rssys.hr_hdmf WHERE COALESCE(cancel,cancel,'')<>'Y' and "+col);
