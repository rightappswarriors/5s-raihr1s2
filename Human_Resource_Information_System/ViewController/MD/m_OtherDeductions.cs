...
namespace Human_Resource_Information_System
{
    public partial class m_OtherDeductions : Form
    {
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            String code = "", description = "", at_code = "";
            ...
            if(isnew)
            {
                col = "code,description,at_code";
                val = "" + db.str_E(code) + "," + db.str_E(description) + ",'" + at_code + "'";
            ...
            {
                col = "description=" + db.str_E(description) + ",at_code = '" + at_code + "'";
            ...
            try
            {
                ...
                if (dgv_list.Rows.Count > 1 && !String.IsNullOrEmpty(code))
                {
                    try
                    {
                        ...
                        cbo_cledger.SelectedValue = db.get_colval("hr_other_deductions", "at_code", "code= '" + code + "'");
                    }
                    catch (Exception er) { }
        ...
        private void disp_search_list(String col)
        {
            ...
            DataTable dt = db.QueryBySQLCode("SELECT * from rssys.hr_other_deductions WHERE COALESCE(cancel,cancel,'')<>'Y' and "+col);
