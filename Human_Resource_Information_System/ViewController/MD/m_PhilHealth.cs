...
namespace Human_Resource_Information_System
{
    public partial class m_PhilHealth : Form
    {
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            String code = "", bracket1 = "", bracket2 = "", salary_base = "", emp_er = "", emp_ee = "",at_code="";
            ...
            if(isnew)
            {
                col = "code,bracket1,bracket2,salary_base,emp_er,emp_ee,at_code";
                val = "" + db.str_E(code) + ",'" + bracket1 + "','" + bracket2 + "','" + salary_base + "','" + emp_er + "','" + emp_ee + "','" + at_code + "'";
            ...
            {
                col = "bracket1='" + bracket1 + "',bracket2='" + bracket2 + "',salary_base='" + salary_base + "',emp_er='" + emp_er + "',emp_ee='" + emp_ee + "',at_code = '"+at_code+"'";
            ...
            try
            {
                ...
                if (dgv_list.Rows.Count > 1 && !String.IsNullOrEmpty(id))
                {
                    ...
                    try
                    {
                        ...
                        cbo_cledger.SelectedValue = db.get_colval("hr_philhealth", "at_code", "code= '" + id + "'");
        ...
        private void disp_search_list(String col)
        {
            ...
            DataTable dt = db.QueryBySQLCode("SELECT * from rssys.hr_philhealth WHERE COALESCE(cancel,cancel,'')<>'Y' and "+col);
