...
namespace Human_Resource_Information_System
{
    public partial class m_Section : Form
    {
        ...
        private void m_Section_Load(object sender, EventArgs e)
        {
            ...
            cbo_searchby.Items.Insert(1, "SECTION NAME");
            disp_list();
        }
        ...
        private void disp_search_list(String col)
        {
            ...
            DataTable dt = db.QueryBySQLCode("SELECT * FROM rssys.hr_depsection WHERE COALESCE(cancel,cancel,'')<>'Y' and "+col);
