...
namespace Human_Resource_Information_System
{
    ...
    public partial class m_payrollperiod : Form
    {
        ...
        private void btn_save_Click_1(object sender, EventArgs e)
        {
            ...
            String pay_code = "", date_from = "", date_to = "", d_w_tax = "", d_sss_c = "", d_philhealth = "", d_pagibig = "", financial_year = "", month = "", pay_type = "", num_days = "", payroll_classic = "", gen_13_month = "N", gen_13_month_from = "2018-01-02", gen_13_month_to = "2018-01-02";
            ...
            if (cbo_13_month.SelectedIndex == 0)
            {
                gen_13_month = "Y";
            ...
            {
                gen_13_month = "N";
                gen_13_month_from = dtp_gen13month_from.Value.ToShortDateString();
                gen_13_month_to = dtp_gen13month_to.Value.ToShortDateString();
                
            }
             gen_13_month_from = gm.toDateString(dtp_gen13month_from.Value.ToShortDateString(),"");
             gen_13_month_to = gm.toDateString(dtp_gen13month_to.Value.ToShortDateString(),"");
            
            pay_code = txt_code.Text;
            date_from = gm.toDateString(dtp_from.Value.ToShortDateString(),"");
            date_to = gm.toDateString(dtp_to.Value.ToShortDateString(),"");
            ...
            if (isnew)
            {
                ...
                col = "pay_code,date_from,date_to,d_w_tax,d_sss_c ,d_philhealth,d_pagibig,financial_year,month,pay_type,num_days,payroll_classic,gen_13_month,gen_13month_from,gen_13month_to";
                val = "" + db.str_E(pay_code) + ",'" + date_from + "','" + date_to + "','" + d_w_tax + "','" + d_sss_c + "','" + d_philhealth + "','" + d_pagibig + "','" + financial_year + "','" + month + "','" + pay_type + "','" + num_days + "','" + payroll_classic + "','" + gen_13_month + "','" + gen_13_month_from + "','" + gen_13_month_to + "'";
            ...
            {
                col = "date_from='" + date_from + "',date_to='" + date_to + "',d_w_tax='" + d_w_tax + "',d_sss_c='" + d_sss_c + "',d_philhealth='" + d_philhealth + "',d_pagibig='" + d_pagibig + "',financial_year='" + financial_year + "',month='" + month + "',pay_type='" + pay_type + "',num_days='" + num_days + "',payroll_classic='" + payroll_classic + "',gen_13_month='" + gen_13_month + "',gen_13month_from='" + gen_13_month_from + "',gen_13month_to='"+gen_13_month_to+"'"; 
        ...
        private void disp_list()
        {
            ...
            int i = 0;
            String type = "";
            DataTable dt = db.QueryBySQLCode("SELECT * FROM rssys.hr_payrollpariod WHERE COALESCE(cancel,cancel,'')<>'Y' ORDER BY date_from DESC");
            ...
            try
            {
                ...
                if (dgv_list.Rows.Count > 1 && !String.IsNullOrEmpty(id))
                {
                    try
                    {
                        ...
                        ///gen_13month_from date,gen_13month_to date,
                        dtp_gen13month_from.Value = Convert.ToDateTime(dt.Rows[0]["gen_13month_from"].ToString());
                        dtp_gen13month_to.Value = Convert.ToDateTime(dt.Rows[0]["gen_13month_to"].ToString());
                        ...
                        if (dt.Rows[0]["gen_13_month"].ToString() == "Y")
                        {
                            cbo_13_month.SelectedIndex = 0;
                        }
                        else
                        {
                            cbo_13_month.SelectedIndex = 1;
                        }
        ...
        {
            String dtpfrom = dtp_from.Value.ToShortDateString();
            String dtpto = dtp_to.Value.ToShortDateString();
            String total = get_total_day(dtpfrom, dtpto);
            txt_num_days.Text = total;
        }
        ...
        private void cbo_13_month_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbo_13_month.SelectedIndex == 0)
            {
                ...
                dtp_gen13month_from.Visible = true;
                dtp_gen13month_to.Visible = true;
            }
            else
            {
                ...
                dtp_gen13month_from.Visible = false;
                dtp_gen13month_to.Visible = false;
            }
        }
        ...
        private void disp_search_list(String col)
        {
            ...
            int i = 0;
            String type = "";
            DataTable dt = db.QueryBySQLCode("SELECT * FROM rssys.hr_payrollpariod WHERE COALESCE(cancel,cancel,'')<>'Y' and "+col);
