...
namespace Human_Resource_Information_System
{
    public partial class rpt_dtr_summary : Form
    {
                ...
                if (sched.Rows.Count > 0)
                {
                    ...
                    foreach (DateTime day in EachDay(pdate_from, pdate_to))
                    {
                        ...
                        if (check == false)
                        {
                            ...
                            {
                                overtime = "8:00:00";
                                dototal += Convert.ToDouble(TimeSpan.Parse(overtime).TotalHours);
                            }
        ...
        private String compute_fix_absent(String empid, String date_from, String date_to, String total_worked)
        {
            ...
            int off1 = Convert.ToInt32(dayoff1[0].ToString()) - 1;
            //error off 2 
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            int r = -1;
            String dtr_filename = "";
            String sys_dir = "\\\\RIGHTAPPS\\RightApps\\SACRED\\Reports\\payroll_pdf_report\\dtr\\";
        ...
        private void bgworker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            System.IO.FileStream fs = new FileStream("\\\\RIGHTAPPS\\RightApps\\SACRED\\Reports\\payroll_pdf_report\\dtr\\" + filename, FileMode.Create);
