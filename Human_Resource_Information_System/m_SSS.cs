...
namespace Human_Resource_Information_System
{
    public partial class m_SSS : Form
    {
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            String atcode = cbo_cledger.SelectedValue.ToString();
            if(isnew)
            {
                col = "code,bracket1,bracket2,s_credit,empshare_sc,s_ec,empshare_ec,at_code";
                val = "" + db.str_E(code) + ",'" + bracket1 + "','" + bracket2 + "','" + s_credit + "','" + empshare_sc + "','" + s_ec + "','" + empshare_ec + "','"+atcode+"'";
            ...
            {
                col = "bracket1='" + bracket1 + "',bracket2='" + bracket2 + "',s_credit='" + s_credit + "',empshare_sc='" + empshare_sc + "',s_ec='" + s_ec + "',empshare_ec='" + empshare_ec + "',at_code = '"+atcode+"'";
            ...
            try
            {
                ...
                if (dgv_list.Rows.Count > 1 && !String.IsNullOrEmpty(id))
                {
                    ...
                    try
                    {
                        ...
                        cbo_cledger.SelectedValue = db.get_colval("hr_sss", "at_code", "code= '"+id+"'");
                    }
                    catch (Exception er) { }
        ...
        private void disp_search_list(String col)
        {
            ...
            DataTable dt = db.QueryBySQLCode("SELECT * from rssys.hr_sss WHERE COALESCE(cancel,cancel,'')<>'Y' and "+col);
